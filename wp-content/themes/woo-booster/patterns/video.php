...
?>
<!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:spacer {"height":"80px"} -->
...
<h2 class="wp-block-heading has-hind-font-family" style="margin-bottom:var(--wp--preset--spacing--20);font-size:32px;font-style:normal;font-weight:700;line-height:1.2"><?php echo esc_html__( 'Unveiling Elegance: The Latest in Fashion Trends!', 'woo-booster' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:embed {"url":"","type":"video","providerNameSlug":"youtube","responsive":true,"className":""} /--></div>
<!-- /wp:group -->
