...
/**
 * Displays the Registration or Pages link.
 *
...
function wp_register( $before = '<li>', $after = '</li>', $display = true ) {
	if ( ! is_user_logged_in() ) {
		...
		$link = $before . '<a href="' . admin_url() . '">' . __( 'Site Pages' ) . '</a>' . $after;
	} else {
		$link = '';
	}

	/**
	 * Filters the HTML link to the Registration or Pages page.
	 *
	 ...
	 * @since 1.5.0
	 *
	 * @param string $link The HTML code for the link to the Registration or Pages page.
	 */
 ...
 * - 'admin_email' - Pages email (set in Settings > General)
