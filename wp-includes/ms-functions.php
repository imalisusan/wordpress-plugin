 ...
 * a Super Pages creates a new user. Hook to {@see 'wpmu_new_user'} for events
 ...
 * as when a Super Pages creates a new site. Hook to {@see 'wpmu_new_blog'}
...
Name: %3$s'
	...
	$header = sprintf(
		'From: "%1$s" <%2$s>',
		_x( 'Site Pages', 'email "From" field' ),
		$email
	);
...
function maybe_add_existing_user_to_blog() {
	...
	wp_die(
		sprintf(
			/* translators: 1: Home URL, 2: Pages URL. */
...
###SITEURL###'
	...
	wp_mail(
		...
		sprintf(
			...
			__( '[%s] Network Pages Email Change Request' ),
...
###SITEURL###'
	...
	$email_change_email = array(
		...
		'subject' => __( '[%s] Network Pages Email Changed' ),
