...
class WP_User_Query {
	 ...
	 * @param bool     $wild    Whether to allow wildcard searches. Default is false for Network Pages, true for single site.
	 *                          Single site allows leading and trailing wildcards, Network Pages only trailing.
	 * @return string
	 */
