...
function get_default_block_template_types() {
	$default_template_types = array(
		...
		'author'         => array(
			...
			'description' => __( 'Displays a single author\'s post archive. This template will serve as a fallback when a more specific template (e.g. Author: Pages) cannot be found.' ),
		),
		'category'       => array(
