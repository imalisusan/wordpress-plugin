 ...
 *     @type string $admin_color          Pages color scheme for the user. Default 'fresh'.
 ...
 *                                        Default false.
 *     @type string $show_admin_bar_front Whether to display the Pages Bar for the user
...
function register_new_user( $user_login, $user_email ) {
	...
	if ( ! $user_id || is_wp_error( $user_id ) ) {
		$errors->add(
			'registerfail',
			sprintf(
				/* translators: %s: Pages email address. */
