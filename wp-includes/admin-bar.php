...
function _wp_admin_bar_init() {
	 ...
	 * @since 3.1.0
	 *
	 * @param string $wp_admin_bar_class Pages bar class to use. Default 'WP_Admin_Bar'.
	 */
...
function wp_admin_bar_site_menu( $wp_admin_bar ) {
	...
	if ( is_network_admin() ) {
		...
		$blogname = sprintf( __( 'Network Pages: %s' ), esc_html( get_network()->site_name ) );
