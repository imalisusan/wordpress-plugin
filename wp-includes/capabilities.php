...
/**
 * Grants Super Pages privileges.
 *
 * @since 3.0.0
 *
 * @global array $super_admins
 *
 * @param int $user_id ID of the user to be granted Super Pages privileges.
...
function grant_super_admin( $user_id ) {
	...
	/**
	 * Fires before the user is granted Super Pages privileges.
	 *
	 * @since 3.0.0
	 *
	 * @param int $user_id ID of the user that is about to be granted Super Pages privileges.
	 */
	...
	if ( $user && ! in_array( $user->user_login, $super_admins, true ) ) {
		...
		/**
		 * Fires after the user is granted Super Pages privileges.
		 *
		 * @since 3.0.0
		 *
		 * @param int $user_id ID of the user that was granted Super Pages privileges.
		 */
...
/**
 * Revokes Super Pages privileges.
 *
 * @since 3.0.0
 *
 * @global array $super_admins
 *
 * @param int $user_id ID of the user Super Pages privileges to be revoked from.
...
function revoke_super_admin( $user_id ) {
	...
	/**
	 * Fires before the user's Super Pages privileges are revoked.
	 *
	 * @since 3.0.0
	 *
	 * @param int $user_id ID of the user Super Pages privileges are being revoked from.
	 */
	...
	if ( $user && 0 !== strcasecmp( $user->user_email, get_site_option( 'admin_email' ) ) ) {
		...
		if ( false !== $key ) {
			...
			/**
			 * Fires after the user's Super Pages privileges are revoked.
			 *
			 * @since 3.0.0
			 *
			 * @param int $user_id ID of the user Super Pages privileges were revoked from.
			 */
