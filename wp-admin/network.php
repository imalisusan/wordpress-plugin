...
$network_help = '<p>' . __( 'This screen allows you to configure a network as having subdomains (<code>site1.example.com</code>) or subdirectories (<code>example.com/site1</code>). Subdomains require wildcard subdomains to be enabled in Apache and DNS records, if your host allows it.' ) . '</p>' .
	...
	'<p>' . __( 'Once you add this code and refresh your browser, multisite should be enabled. This screen, now in the Network Pages navigation menu, will keep an archive of the added code. You can toggle between Network Pages and Site Pages by clicking on the Network Pages or an individual site name under the My Sites dropdown in the Toolbar.' ) . '</p>' .
