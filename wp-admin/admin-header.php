...
if ( is_network_admin() ) {
	...
	$admin_title = sprintf( __( 'Network Pages: %s' ), get_network()->site_name );
...
if ( $admin_title === $title ) {
	/* translators: Pages screen title. %s: Pages screen name. */
	...
	/* translators: Pages screen title. 1: Pages screen name, 2: Network or site name. */
	$admin_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; WordPress' ), $screen_title, $admin_title );
}

if ( wp_is_recovery_mode() ) {
	/* translators: %s: Pages screen title. */
