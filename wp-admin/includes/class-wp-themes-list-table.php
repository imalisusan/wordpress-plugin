		...
		if ( is_multisite() ) {
			if ( current_user_can( 'install_themes' ) && current_user_can( 'manage_network_themes' ) ) {
				printf(
					...
					__( 'You only have one theme enabled for this site right now. Visit the Network Pages to <a href="%1$s">enable</a> or <a href="%2$s">install</a> more themes.' ),
				...
				printf(
					...
					__( 'You only have one theme enabled for this site right now. Visit the Network Pages to <a href="%s">enable</a> more themes.' ),
					network_admin_url( 'site-themes.php?id=' . $blog_id )
				);
