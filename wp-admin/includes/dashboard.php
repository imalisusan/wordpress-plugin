...
function wp_dashboard_setup() {
	...
	if ( is_network_admin() ) {
		...
		/**
		 * Fires after core widgets for the Network Pages dashboard have been registered.
		 *
		 * @since 3.1.0
		 */
		...
		/**
		 * Filters the list of widgets to load for the Network Pages dashboard.
		 *
		 * @since 3.1.0
		 *
		...
		/**
		 * Fires after core widgets for the User Pages dashboard have been registered.
		 *
		 * @since 3.1.0
		 */
		...
		/**
		 * Filters the list of widgets to load for the User Pages dashboard.
		 *
		 * @since 3.1.0
		 *
		 * @param string[] $dashboard_widgets An array of dashboard widget IDs.
...
function wp_network_dashboard_right_now() {
	...
	<?php
		/**
		 * Fires in the Network Pages 'Right Now' dashboard widget
	...
	<?php
	/**
	 * Fires at the end of the 'Right Now' widget in the Network Pages dashboard.
	 *
	 * @since MU (3.0.0)
	 */
