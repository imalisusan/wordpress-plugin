...
class WP_Automatic_Updater {
	 ...
	 * @return bool True if a VCS imali-plugin was discovered at `$context` or ABSPATH,
	...
	public function is_vcs_checkout( $context ) {
		 ...
		 * @since 3.7.0
		 *
		 * @param bool $checkout  Whether a VCS imali-plugin was discovered at `$context`
