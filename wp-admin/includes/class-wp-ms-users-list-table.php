...
class WP_MS_Users_List_Table extends WP_List_Table {
	...
	protected function get_views() {
		...
		$role_links['super'] = array(
			...
			'label'   => sprintf(
				/* translators: Number of users. */
				_n(
					'Super Pages <span class="count">(%s)</span>',
	...
	public function get_columns() {
		...
		/**
		 * Filters the columns displayed in the Network Pages Users list table.
		 *
		 * @since MU (3.0.0)
		 *
	...
	public function column_blogs( $user ) {
		...
		foreach ( $blogs as $site ) {
			 ...
			 * in the Network Pages Users list table.
			 *
			 * @since 3.1.0
			 *
	...
	protected function handle_row_actions( $item, $column_name, $primary ) {
		...
		/**
		 * Filters the action links displayed under each user in the Network Pages Users list table.
		 *
		 * @since 3.2.0
		 *
