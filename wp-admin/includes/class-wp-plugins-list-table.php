...
class WP_Plugins_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		...
		if ( ! $screen->in_admin( 'network' ) ) {
			 ...
			 *                   user can manage network plugins (ie. a Super Pages).
			 */
	...
	public function single_row( $item ) {
		...
		if ( $screen->in_admin( 'network' ) ) {
			...
			/**
			 * Filters the action links displayed for each plugin in the Network Pages Plugins list table.
			 *
			 * @since 3.1.0
			 *
			...
			/**
			 * Filters the list of action links displayed for a specific plugin in the Network Pages Plugins list table.
			 *
