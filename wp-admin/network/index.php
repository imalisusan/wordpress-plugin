...
$overview  = '<p>' . __( 'Welcome to your Network Pages. This area of the Administration Screens is used for managing all aspects of your Multisite Network.' ) . '</p>';
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://wordpress.org/documentation/article/network-admin/">Documentation on the Network Pages</a>' ) . '</p>' .
