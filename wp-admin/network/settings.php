...
get_current_screen()->add_help_tab(
	array(
		...
		'content' =>
			...
			'<p>' . __( 'Super admins can no longer be added on the Options screen. You must now go to the list of existing users on Network Pages > Users and click on Username or the Edit action link below that name. This goes to an Edit User page where you can check a box to grant super admin privileges.' ) . '</p>',
	)
);
...
<div class="wrap">
	...
	<form method="post" action="settings.php" novalidate="novalidate">
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="admin_email"><?php _e( 'Network Pages Email' ); ?></label></th>
				<td>
